...
#Added to git rid of initial hardcodes
import os
from dotenv import load_dotenv
load_dotenv()

_test_yaml          = 'TEST_ARTIFACTS/dataimage.airflowimage.manifests.deployment.yaml'
_secret_yaml1 = os.getenv('HELM_VALUES')
_secret_yaml2 = os.getenv('TANGO_VALUES')
_secret_yaml3 = os.getenv('CHARTS_VALUES')
_secret_yaml4 = os.getenv('SKAMPI_VALUES')
_secret_yaml5 = os.getenv('MINECRAFT_VALUES')
_secret_yaml6 = os.getenv('KUBECF_VALUES_1')
_secret_yaml7 = os.getenv('NEXTCLOUD_VALUES')
_secret_yaml8 = os.getenv('KEYCLOAK_VALUES')
_secret_yaml9 = os.getenv('EMPTY_VALUES')
_secret_yaml10 = os.getenv('KUBECF_VALUES_2')
...
special_secret_1 = os.getenv('SPECIAL_SECRET_1') #modified
